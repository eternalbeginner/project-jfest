  ...
  return (
    <section
      ...
      <Text css={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        ...
        <span>
          These factors make JFEST one of our means of introducing Japanese culture in a way that is
          fun and enjoyed by various groups both inside and outside the campus environment.
        </span>
      </Text>
    </section>
  );
