      ...
      <div
        ...
        <div
          ...
          <header style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <Title css={{ fontSize: '3em', '@tablet': { fontSize: '2em' } }}>JFEST</Title>
            <div
              className={css({
                display: 'flex',
                alignItems: 'flex-start',
              ...
              <Title css={{ fontSize: '1em', '@tablet': { fontSize: '1em' } }}>By</Title>
              <Title css={{ fontSize: '2em', '@tablet': { fontSize: '1.5em' } }}>JCOS</Title>
            </div>
          </header>
          <Text
            css={{
            ...
            <span>
              These factors make JFEST one of our means of introducing Japanese culture in a way
              that is fun and enjoyed by various groups both inside and outside the campus
              environment.
            </span>
          </Text>
        </div>
